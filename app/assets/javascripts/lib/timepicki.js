	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='previ action-previ'></div>" :
				"<div class='previ action-nexti'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='nexti action-nexti'></div>" :
				"<div class='nexti action-previ'></div>";
			...
			function change_time(cur_ele, direction) {
				...
				if ((cur_ele && cur_ele.hasClass('action-nexti')) || direction === 'nexti') {
				...
				} else if ((cur_ele && cur_ele.hasClass('action-previ')) || direction === 'previ') {
			...
			var cur_next = ele_next.find(".action-nexti");
			var cur_prev = ele_next.find(".action-previ");
